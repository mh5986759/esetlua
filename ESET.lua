...
--**********************--
--*********SUDO ID*******--
sudo_users = {342293523,304145924,272376346,287192786,258220821,192191034,181612899,289063789} -- [[محل قرار گیری آیدی سودو ها]]
--***********************--
--********BOT OWNER******--
bot_owner = 304145924 -- [[ محل قرار گیری آیدی مدیر اصلی ربات ]]
--***********************--
-----------------------------------------------------------------------------------------------
---------------
-- Start Functions --
